      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <Link to="/" className="flex items-center">
            <span className="ml-2 text-xl font-bold text-white">IITM BS Electronic Systems</span>
          </Link>
          <div className="hidden lg:flex items-center space-x-8">
            ...
            <Link to="/partnerships" className="text-gray-300 hover:text-[#4b7bff] transition">Partnerships</Link>
            <Link to="/contact" className="text-gray-300 hover:text-[#4b66ff] transition">Contact</Link>
            <DashboardButton />
          </div>
          <button 

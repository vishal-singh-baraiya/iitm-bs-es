      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="mt-16">
          <div className="flex items-center gap-2 mb-6">
            <GraduationCap className="h-6 w-6 text-[#4b7eff]" />
            ...
            <ul className="space-y-3">
              {eligibilityCriteria.map((criteria, index) => (
                <li key={index} className="flex items-center gap-2 text-gray-300">
                  <div className="h-1.5 w-1.5 rounded-full bg-[#4b7bff]" />
                  {criteria}
                </li>
              ))}
            </ul>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {entranceExamSyllabus.map((subject, index) => (
              <Card key={index} className="bg-white/5 backdrop-blur-lg border border-white/10">
                ...
                <p className="text-blue-500 mb-4">Requirement: <span className="text-gray-300 text-sm mb-4">{subject.requirement}</span></p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {scholarships.map((scholarship, index) => (
              <Card key={index} className="bg-white/5 backdrop-blur-lg border border-white/10">
                ...
                <p className="text-[#4b78ff] font-semibold mb-2">{scholarship.amount}</p>
            ...
            <div className="space-y-4">
              {importantDates.map((item, index) => (
                <div key={index} className="flex justify-between items-center py-2 border-b border-white/10 last:border-0">
                  ...
                  <span className="text-[#4b78ff] font-semibold">{item.date}</span>
                </div>
              ))}
            </div>
          </Card>
...
<section className="mt-16">
  <div className="flex items-center gap-2 mb-6">
    <Trophy className="h-6 w-6 text-[#4b7bff]" />
